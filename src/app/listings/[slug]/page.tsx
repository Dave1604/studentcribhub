        ...
        <div className="mx-auto max-w-6xl px-4 py-6 sm:px-6">
          ...
          <div className="mt-8 grid gap-8 lg:grid-cols-[1fr_360px]">
            <div className="min-w-0">
              ...
              <section className="border-b border-border py-6">
                <h2 className="font-display text-xl text-foreground">What this place offers</h2>
              ...
              {/* Landlord */}
              <section className="border-b border-border py-6">
                <h2 className="font-display text-xl text-foreground">Your landlord</h2>
              ...
              <section className="py-6">
                ...
                <div className="mt-4 grid gap-4 sm:grid-cols-2">
                  {sampleReviews.map((r) => (
                    <figure key={r.name} className="rounded-xl border border-border bg-card p-4">
            ...
            <aside className="lg:relative">
              <div className="sticky top-24 rounded-2xl border border-border bg-card p-6 shadow-lg">
                ...
                <Button className="mt-4 h-11 w-full text-[0.95rem]">Request to book</Button>
